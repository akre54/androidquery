...
public class TumblrHandle extends AccountHandle{

	private static final String OAUTH_REQUEST_TOKEN = "https://www.tumblr.com/oauth/request_token";
	private static final String OAUTH_ACCESS_TOKEN = "https://www.tumblr.com/oauth/access_token";
	private static final String OAUTH_AUTHORIZE = "https://www.tumblr.com/oauth/authorize";
	private static final String CALLBACK_URI = "tumblr://callback";
	private static final String CANCEL_URI = "tumblr://cancel";
	...
	public TumblrHandle(Activity act, String consumerKey, String consumerSecret) {
		
		this.act = act;
		
		consumer = new CommonsHttpOAuthConsumer(consumerKey, consumerSecret);
		
		token = fetchToken(TM_TOKEN);
		secret = fetchToken(TM_SECRET);
	...
	private class Task extends AsyncTask<String, String, String> implements OnCancelListener, Runnable{
		...
		protected void onPostExecute(String url) {
			...
			if(url != null){
				...
				dialog = new WebDialog(act, url, new TmWebViewClient());		
	...
	private static final String TM_TOKEN = "aq.tm.token";
	private static final String TM_SECRET = "aq.tm.secret";
	...
	private class Task2 extends AsyncTask<String, String, String>{
		...
		protected void onPostExecute(String url) {
			...
			if(url != null){
				...
				storeToken(TM_TOKEN, token, TM_SECRET, secret);
	...
	public boolean reauth(final AbstractAjaxCallback<?, ?> cb) {
		...
		token = null;
		secret = null;
		storeToken(TM_TOKEN, null, TM_SECRET, null);
